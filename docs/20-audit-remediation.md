...
- The trained GB10 benchmarks measured a dense-to-routed median-latency ratio of
  ...
  seeds, with routed peak allocated memory below dense in every seed. This is
...
2. **Design a real C1/C2 test — open, and now better specified.** C4 has been
   ...
   remains is a task where homological exactness is *causally relevant* and the
