...
H4 remains a prespecified secondary analysis with an unadjusted 95% interval; it
...
now labeled non-informative rather than a routing null. The 25/28 selection count
and always-cell reanalysis are descriptive only.
...
conversion campaign, runs tests, and regenerates figures and the paper. It
...
The learned-conversion parameter count is corrected to median `E×F = 242`
